...
class SalesOrderCompletedMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: "Halo, {$this->sales_order->customer->name}, Pesanan Nomor #{$this->sales_order->trx_id} sudah sampai di tujuan alamat anda",
    ...
    {
        return new Content(
            markdown: 'components.customers.mail.orders.completed-sales-order-mail',
        );
    }
