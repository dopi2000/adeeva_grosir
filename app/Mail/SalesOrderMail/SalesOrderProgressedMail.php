...
class SalesOrderProgressedMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: "Halo, {$this->sales_order->customer->name}, Pesanan Nomor #{$this->sales_order->trx_id} sudah kami terima dan kami proses",
    ...
    {
        return new Content(
            markdown: 'components.customers.mail.orders.progressed-sales-order-mail',
        );
    }
