    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="{{ route('home') }}" class="flex items-center">
                ...
                <span class="self-center text-xl font-semibold whitespace-nowrap">Adeeva Grosir</span>
            </a>
            <div class="flex items-center lg:order-2">
                ...
                <button id="dropdownAvatarNameButton" data-dropdown-toggle="dropdownAvatarName" class="flex items-center text-sm pe-1 font-medium text-gray-900 rounded-full hover:text-blue-600 md:me-0 focus:ring-4 focus:ring-gray-100" type="button">
                    ...
                    <img class="w-8 h-8 me-2 rounded-full" src="{{ Auth::user()->avatar ? asset("storage/" . Auth::user()->avatar) : asset('avatar/avatar-default.jpg') }}" alt="user photo">
                    {{ Auth::user()->name }}
                ...
                <div id="dropdownAvatarName" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44">
                    ...
                    <div class="py-2">
                    <a href="{{ route('logout.customer') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Keluar</a>
                    </div>
                </div>

                @else
                <a href="{{ route('login') }}" class="text-gray-800 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-2 lg:px-3 py-1 lg:py-1.5 mr-2 focus:outline-none">Masuk</a>
                <a href="{{ route('register') }}" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-2 lg:px-3 py-1 lg:py-1.5 mr-2 focus:outline-none">Daftar</a>
                @endif
