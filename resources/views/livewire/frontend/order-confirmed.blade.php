<div>
    ...
    <div class="container mx-auto max-w-[85rem] w-full px-4 sm:px-6 lg:px-8 py-10">
        <div class="w-full p-5 mx-auto md:w-1/2">
            <div class="relative flex flex-col bg-white shadow-lg pointer-events-auto rounded-xl ">
                ...
                <div class="p-4 overflow-y-auto sm:p-7">
                    <div class="text-center">
                        <h3 id="hs-ai-modal-label" class="text-lg font-semibold text-gray-800 ">
                            Faktur dari {{ config('app.name') }}
                        </h3>
                    ...
                    <div class="mt-5 sm:mt-10">
                        <h4 class="text-xs font-semibold text-gray-800 uppercase ">Ringakasan Pembayaran</h4>

                        <ul class="flex flex-col mt-3">
                            <li
                                class="inline-flex items-center px-4 py-3 -mt-px text-sm text-gray-800 border border-gray-200 gap-x-2 first:rounded-t-lg first:mt-0 last:rounded-b-l ">
                            ...
                            <li
                                ...
                                <div class="flex items-center justify-between w-full">
                                    ...
                                    <span>{{ $order->due_date_at->translatedFormat('d F Y - H:i:s') }} WIT</span>
                                </div>
                            </li>
                            <li
                                class="inline-flex items-center px-4 py-3 -mt-px text-sm text-gray-800 border border-gray-200 gap-x-2 first:rounded-t-lg first:mt-0 last:rounded-b-l ">
                    ...
                    <div class="block my-2">
                        <p class="text-sm text-gray-500 ">Silakan transfer hingga 3 digit terakhir</p>
                    </div>
                    ...
                    @if ($order->status === "App\States\SalesOrder\Pending")
                        ...
                        @else
                        <span class="text-sm font-medium text-gray-500">Hubungi Layanan Pengaduan Kami di Nomor 082142531838</span>
                        @endif
                    @endif
                    <!-- End Buttons -->
                    ...
                    <div class="my-5 hs-accordion-group">
                        <div class="hs-accordion active" id="hs-basic-with-title-and-arrow-stretched-heading-one">
                            <button
                                class="inline-flex items-center justify-between w-full py-3 font-semibold text-gray-800 rounded-lg hs-accordion-toggle hs-accordion-active:text-blue-600 gap-x-3 text-start hover:text-gray-500 disabled:opacity-50 disabled:pointer-events-none ive:text-blue-500  al-400 dden al-400"
                                aria-expanded="true"
                            ...
                            <div id="hs-basic-with-title-and-arrow-stretched-collapse-one"
                                ...
                                <x-customers.frontend.single-product-list :item="$item    "/>
                                @endforeach
                            </div>
